  ...
  const responseBody = [
    {
      book_id: 1,
      title: '제목 테스트 1',
      created_at: '2024-01-12T21:46:54.796769+09:00',
      image_url: null,
    },
    {
      book_id: 2,
      title: '제목 테스트 2',
      created_at: '2024-01-12T22:20:40.914999+09:00',
      image_url: null,
    },
    {
      book_id: 3,
      ...
      <div className="flex flex-col w-screen h-screen bg-mainColor bg-opacity-15 relative z-10">
        ...
        {todos.map((todo) => (
          <li key={todo.id}>
            ...
            />
            {todo.thumbnail && <img src={todo.thumbnail} alt="thumbnail" />}
            <span>{todo.title}</span>
            <button onClick={() => deleteTodo(todo.id)}>삭제</button>
          </li>
        ))}
      </ul> */}
              {responseBody.map((book) => (
              ...
              {/* <div className="flex-col w-64 h-[21rem] bg-[#f2f2f2] bg-opacity-65 rounded-2xl mt-4">
                ...
                <div className="text-[#002050] font-dongle text-[2.2rem] p-4">나 홀로 크리스마스2</div>
              </div>
              <div className="flex-col w-64 h-[21rem] bg-[#f2f2f2] bg-opacity-65 rounded-2xl mt-4">
                <div className="w-64 h-64">
                  <img src={thumbnail} />
                </div>
                <div className="text-[#002050] font-dongle text-[2.2rem] p-4">나 홀로 크리스마스3</div>
              </div>
              <div className="flex-col w-64 h-[21rem] bg-[#f2f2f2] bg-opacity-65 rounded-2xl mt-4">
                <div className="w-64 h-64">
                  <img src={thumbnail} />
                </div>
                <div className="text-[#002050] font-dongle text-[2.2rem] p-4">나 홀로 크리스마스4</div>
              </div> */}
            </div>
          </div>
